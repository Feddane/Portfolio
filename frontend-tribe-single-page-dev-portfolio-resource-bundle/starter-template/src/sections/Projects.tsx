  ...
  return <div>
    <section className="pb-16 ">
      <div className="container">
        ...
        <div className="flex flex-col mt-10 gapt-14">
          {portfolioProjects.map((project) => (
            <div key={project.title} className="bg-gray-800 relative z-0 overlfow-hidden after:content-[''] after:absolute after:inset-0  after:outline-2 after:outline after:-outline-offset-2 after:z-10 after:rounded-3xl after:outline-white/20 px-8 pt-8">
              ...
              <ul className="flex felx-col gap-4 mt-4">
